...
public class DialogueScript : MonoBehaviour
{
    ...
    public IEnumerator StartDialogue2(AudioSource audioSource)
    {
        ...
        for (int i = 0; i < dialogues.Count; i++)
        {
            ...
            {
                if (GameManager.instance.isPaused && (!GameManager.instance.shopMenu.activeSelf || !GameManager.instance.shopTransition.activeSelf)) // If the game is paused, wait for it to be UNPAUSED before continuing.
                {
